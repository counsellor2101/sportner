...
import { openPushSettings } from "../push/openSettings"
...
async function handleConfirm() {
  if (confirm.type === "delete") {
    await deleteRule(confirm.payload)
  }
...
>
  ...
  <ConfirmModal
  open={confirm.open}
  type={confirm.type === "delete" ? "danger" : "default"}

  title={
    confirm.type === "delete"
      ? (t.confirm_delete_rule_title || "Delete rule?")
      : (t.confirm_create_rule_title || "Create notification?")
  }

  message={
    confirm.type === "delete"
      ? (t.confirm_delete_rule_message || "This action cannot be undone.")
      : (t.confirm_create_rule_message || "Do you want to create this rule?")
  }
